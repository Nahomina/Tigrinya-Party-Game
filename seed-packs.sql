...
VALUES
  ...
  ('intermediate', 'ሓዳር',   'Hadar',    'Wedding & Family',    'Marriage, kinship and family life',            4.99, FALSE,  0, 15),
  ('advanced',     'ዓዲ',    'Adi',      'Homeland & Places',   'Villages, geography and diaspora journeys',   4.99, FALSE,  0, 15),
  ('expert',       'ወለዶ',   'Weledo',   'Generations & Wisdom','Advanced proverbs across generations',        4.99, FALSE,  0, 15)
...
INSERT INTO proverbs (tigrinya, latin, english, difficulty, pack_id) VALUES
  ('ሩባ ዘለዎ ፈሳሲ፣ ጎቦ ዘለዎ መላሲ',
   ...
   'easy',
   (SELECT id FROM packs WHERE slug = 'advanced')),
...
INSERT INTO proverbs (tigrinya, latin, english, difficulty, pack_id) VALUES
  ('ልሳን ዓጽሚ የብሉን፡ ግና ዓጽሚ ይሰብር',
   ...
   'easy',
   (SELECT id FROM packs WHERE slug = 'expert')),
...
--   SELECT * FROM mint_pack_codes('intermediate', 50);
--   SELECT * FROM mint_pack_codes('advanced',     50);
--   SELECT * FROM mint_pack_codes('expert',       50);
--
